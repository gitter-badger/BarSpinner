  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new Bar" do
        expect {
          post :create, {:bar => valid_attributes}
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved bar as @bar" do
        post :create, {:bar => invalid_attributes}
        expect(assigns(:bar)).to be_a_new(Bar)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested bar" do
        bar = Bar.create! valid_attributes
        put :update, {:id => bar.to_param, :bar => new_attributes}
        bar.reload
      ...
      it "assigns the requested bar as @bar" do
        bar = Bar.create! valid_attributes
        put :update, {:id => bar.to_param, :bar => valid_attributes}
        expect(assigns(:bar)).to eq(bar)
      end
    ...
    describe "with invalid params" do
      it "assigns the bar as @bar" do
        bar = Bar.create! valid_attributes
        put :update, {:id => bar.to_param, :bar => invalid_attributes}
        expect(assigns(:bar)).to eq(bar)
      end
